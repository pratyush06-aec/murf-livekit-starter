  ...
  ((e.checkMobile = e.checkMobile || {}),
    ...
    (e.checkMobile.css.isLandscape = function () {
      return /Mobi/i.test(navigator.userAgent)
        ? 90 === Math.abs(window.orientation) || screen.availHeight < screen.availWidth
        : [o['data-landscape'].value, 'attr(data-landscape)'].indexOf(n(t().content)) >= 0;
    }));
})((peppers = peppers || {}));
var peppers;
!(function (e, t, n) {
...
!(function (e, t) {
  ((e.formatNumber = function (e) {
    for (var t = [], n = ('' + e).replace(/\s/g, ''); n.length > 0; )
      (t.unshift(n.substr(-3)), (n = n.substr(0, n.length - 3)));
    return t.join(' ');
  }),
  ...
  t(e).ready(function () {
    function n(e) {
      (console.debug('onAccelerometer', e),
        l
          ? ((h.beta = s(-(e.beta - l.beta) / 10, 1) * d),
            (h.gamma = s((e.gamma - l.gamma) / 10, 1) * d))
          : (u.off('mousemove', i), (l = { beta: e.beta, gamma: e.gamma })));
    }
    function i(e) {
    ...
    if (0 != c.length) {
      ...
      (u.mousemove(i), peppers.accelerometer.on('change', n));
      var h = { beta: 0, gamma: 0 },
        f = { beta: 0, gamma: 0 },
        m = { beta: 0.05, gamma: 0.05 },
        g = o,
        v = a;
      r();
    }
    ...
    function i() {
      c ||
        ...
        t.DeviceOrientationEvent
          ? t.addEventListener('deviceorientation', o, !0)
          : t.DeviceMotionEvent
            ? t.addEventListener('devicemotion', o, !0)
            : t.addEventListener('MozOrientation', o, !0));
    }
    function o(e) {
      switch (e.type) {
  ...
  function t(t) {
    ...
    ((this.init = function (o) {
      ...
      (t.wrap("<div class='pep-placeholder'></div>"),
        (r = e(
          "<div class='pep-placeholder__text'>" + (e.isFunction(o) ? o(s) || '' : s) + '</div>'
        )
          .insertBefore(t)
          .addClass(t.get(0).className)),
...
!(function (e) {
  ...
  function n(e, t) {
    ...
    return (
      r.drawImage(e.get(0), 0, 0, n, i, 0, 0, t.width, t.height),
      { width: t.width, height: t.height, data: r.getImageData(0, 0, t.width, t.height).data }
    );
  }
    ...
    if (((t = Math.max(t, e.length / n)), o.length > 1))
      ...
      for (o = e.split(' '); o.length > 0; ) {
        ...
        do {
          var c = o.shift();
          ((s += c.length), r.push(c));
        } while (o.length > 0 && s + 0.5 * o[0].length < t);
        (o.length > 0 &&
          r.length > 1 &&
          ['a', 'the', 'is', 'of'].indexOf(r[r.length - 1].toLowerCase()) >= 0 &&
          o.unshift(r.pop()),
          i.push(r.join(' ')));
      }
    return i;
...
!(function (e, t) {
  function n() {
    ...
    for (
      var a = n / 10 + 1, r = (100 / 86.55) * a + 1, s = [], c = {}, l = 0, d = 0, p = 0;
      p < 1;
      p++
    ) {
      d = 0;
    ...
    ($('<div></div>').addClass('transition__preloader').appendTo(o),
      o.addClass('transition-wrapper_initialized'),
      (this.opened = !1),
...
(!(function (e) {
  function t() {
    function e() {
      r.css(
        'height',
        $(this).outerHeight() + parseInt(r.css('paddingTop')) + parseInt(r.css('paddingBottom'))
      );
    }
    var t = $(this).parent(),
    ...
    (r.css({
      ...
      setTimeout(function () {
        ...
        e.css({
          height:
            a.outerHeight() + parseInt(e.css('paddingTop')) + parseInt(e.css('paddingBottom')),
        });
      }, 50));
  }
    ...
    function i(e) {
      ...
      e.hover(function (e) {
        ...
        n.to(i, a.duration, {
          ...
          ease: a.tween.ease,
          onUpdate: function () {
            t.attr({ y: 50 - 0.5 * i.height + '%', height: i.height + '%' });
          },
        });
      });
    }
    var o = {
      mouseenter: { duration: 0.4, tween: { ease: Sine.easeOut, height: 102 } },
      mouseleave: { duration: 0.2, tween: { ease: Sine.easeIn, height: 0 } },
    };
  ...
  function n(e) {
    ...
    function o() {
      ...
      ((l = setInterval(function () {
        0 == t.y && -1 == t.directionY
          ? e.trigger('scroll:top')
          : t.hasVerticalScroll && e.trigger('scroll:scrolled');
      }, 50)),
    ...
    function r() {
      (0 === this.y ? e.trigger('scroll:top') : e.trigger('scroll:scrolled'),
        ...
        s.hasVerticalScroll
          ? s.indicators[0].wrapper.classList.remove('is-disabled')
          : s.indicators[0].wrapper.classList.add('is-disabled'));
    }
    var s, c, l;
    (e.find('a').on('click', function (e) {
      ...
      (this.refresh = function () {
        return (
          t.checkMobile.css.isMobile() ? (s && (s.destroy(), c.remove()), (s = void 0)) : s || n(),
          s && s.refresh(),
          this
        );
      }));
...
(!(function (e, t) {
  function n() {
    ...
    (t || ((c = setInterval(o, g)), o()),
      i(t),
      e.cookie('muted', t ? 1 : 0, { path: '/', expires: 3650 }));
    var n = e('.sound').get(0);
    (void 0 !== localStorage.sound_progress &&
      (n.currentTime = parseFloat(localStorage.sound_progress)),
  ...
  function o() {
    for (var e = r(), t = 0; t < u.length; t++)
      u[t].css('height', 100 * e(t / (u.length - 1)) + '%');
  }
  function a(e, t) {
  ...
  for (
    var c,
      l = e('.mute-btn_false'),
      d = l.find('label'),
      p = [1, 2, 3, 7, 18, 11, 25, 13, 26, 47, 26, 18, 25, 11, 18, 7, 3, 2, 1],
      u = [],
      h = e('.sound', top.document),
      f = 0;
    f < p.length;
    f++
  ) {
  ...
  (peppers.checkMobile.css.isMobile() && e.cookie('muted', 1, { path: '/', expires: 3650 }),
    l
      .find('.mute-btn__checkbox')
      .change(n)
      .prop('checked', 1 === parseInt(e.cookie('muted')))
      .change());
})(jQuery, document),
  (function (e, t, n, i, o) {
    function a(e, t, n) {
      function i() {
        var e = 0.5 * t;
        (a(s, e, 0.5), a(c, e, 0.5), n || a(h, e + 0.25, 0.3));
      }
      function a(e, t, n, i, a) {
        (e.css('transform', i || 'scale(0)'),
          o.to(e.get(0), n || 0.5, { transform: a || 'scale(1)', delay: t }));
      }
      function r() {
        o.to(e.get(0), 0.3, {
          transform: 'scale(0)',
    ...
    function r(e, t, n) {
      function a() {
        (i('.toogle-map-mobile').stop().fadeOut(300),
          o.to(e.get(0), 0.5, { transform: 'translate(0, 0)' }));
      }
      function r() {
    ...
    ((i.fn.earthPopupItem = function (e, t) {
      ...
      (e.getHexaspherePopup = function (e, n, o) {
        ...
        return (
          s ||
            ((c = i("#earth-popup[type='text/x-handlebars-template']")), (s = t.compile(c.html()))),
          (a = i(s(e)).appendTo(c.parent())),
          a.localization('en'),
          o &&
            ((scriptMobile = i("#earth-mobile-tip[type='text/x-handlebars-template']")),
    ...
    function a(e) {
      ...
      function o(n) {
        if (currentYear != n.data('year')) {
          var o = n.data('year'),
            a = i.PLANET,
            r = !1;
          (a ? a.state == a.IDLE && (a.showYear(o), (r = !0)) : (r = !0),
            r &&
              (t(n).addClass('active').siblings().removeClass('active'),
      ...
      ((this.init = function (o, a) {
        ...
        for (index in o) {
          var r =
            o[index] == a
              ? 'js-timeline-item timeline-new__item active'
              : 'js-timeline-item timeline-new__item';
        ...
        (this.initLinks = function (e, n) {
          e &&
            ((this.activeYears = e.reduce(function (e, t) {
              e[t.year] = e[t.year] || [];
              var i = null;
              if (n) {
            ...
            this.years.forEach(
              t.proxy(function (e) {
                (this.activeYears[e] && 0 != this.activeYears[e].length) ||
                  t('.js-timeline-item[data-year=' + e + ']').addClass('disabled');
              }, this)
            ));
        }));
    }
...
!(function (e, t, n, i, o) {
  function a(o) {
    function a(e, t) {
      (b.briefCommentsList('add', { user: u().user, comment: t }), j.refresh());
    }
    function r(i) {
      var a = arguments[3];
      p !== a &&
    ...
    function s(e) {
      (o.find('.brief-city-name').html(e.location && e.location.city),
        ...
        w.briefModalContent(e),
        b.briefCommentsList(e.comments),
        v.not(':first-of-type').toggle(e.comments && e.comments.length >= 5),
        v
          .find('textarea')
          .attr('placeholder', n.fn.localization.getText('brief.comment.placeholder')),
    ...
    var v = o.find('.add-comment-form').on('add-comment-form:add', a),
      ...
      j = x.scrollbarCustom().data('scrollCustom');
    (x.on('scroll:scrolled', function (e) {
      ...
      n(i.documentElement).on('resize:after', function () {
        if (
          ...
          i.body.clientWidth - 2 * e.offset().left < k.outerWidth() + e.outerWidth()
            ? o.addClass('show-graphics--position-down')
            : o.removeClass('show-graphics--position-down');
        }
      }),
      o.on('modal-item:show  modal-item:hide', function (e) {
        m.always(function () {
          (j.refresh(),
            ...
            h.works_count > 0 && 'modal-item:show' === e.type
              ? (_.attr('href', 'prediction?brief_id=' + p), k.addClass('visible'))
              : (_.attr('href', '#'), k.removeClass('visible')));
        });
      }));
    var C = null;
    (o.on('modal-item:show', function () {
      m.always(function () {
        C ||
          ((C = e.get_metadata()),
          n('title').html(h.title),
          n('meta[property="og:title"]').attr('content', h.title),
          n('meta[property="og:description"]').attr('content', h.stripped_body),
          n('meta[property="og:image"]').attr('content', h.image_share),
          n('meta[property="og:url"]').attr('content', h.share_url),
          n('meta[name="description"]').attr('content', h.stripped_body));
      });
    }),
      o.on('modal-item:hide', function () {
        m.always(function () {
          C && (e.set_metadata(C), (C = null));
        });
      }),
      ...
      (this.init = function (e, t, n, i) {
        (i && (u = i), e && (l = e), n && (d = n), t && v.addCommentForm(t));
      }));
  }
...
(!(function (e, t, n, i, o) {
  ...
  function r(i) {
    function o() {
      ...
      if (!e.liked) {
        ...
        (t('.user__button .user__button-counter').text(parseInt(i) + 1),
          t('.user__button').addClass('active'),
          t('.user__button .user__button-icon').html(c),
          e.likeApi({ artwork_id: e.artwork.id }).fail(function (e) {
            alert(e.statusText);
          }));
      }
    }
  ...
  function s(e) {
    function n(t, n) {
      d || ((d = new c.GUI()), (l = window.panoramaViewer = new c.Player(e, d)));
      var i = t.points;
      if (i) {
        if ('string' == typeof i) {
      ...
      (u.finish().fadeIn(100),
        m.finish().fadeOut(100),
        l.createPanorama(t, function () {
          (u.finish().fadeOut(100), n && n(), g || m.finish().fadeIn(100));
        }),
        (p = l.VR));
    }
    function o(e) {
      (p.enableVR(e), l.fullscreenToggle(e), m.finish().hide());
    }
    function a() {
      (s.addEvent('up', v, r),
        s.addEvent('move', v, function () {
          (m.finish().fadeOut(), s.removeEvent('down', v, a), r(), (g = !0));
        }));
    }
    function r() {
      (s.removeEvent('up', v, r), s.removeEvent('move', v));
    }
    ...
    var l,
      d,
      p,
      u = t('.transition__preloader', e);
    this.init = function (e, t) {
      n(e, t);
    };
    var h = t('.js-vr-tutor, .js-close-vr-tutor'),
      f = t('body');
    (t('.js-open-vr').on('click', function () {
      (h.toggleClass('is-active'), f.toggleClass('is_vr_tutor'));
    }),
  ...
  (function (e, t, n, o, a, r, s, c) {
          ...
          t[n].briefs
            ...
            .forEach(function (t) {
              ((t.link = e.brief_page_link(t)),
                (t.names = [
                  { list: e.trimText(t.name, 18, 3), type: 'desktop' },
    ...
    function d(e, t, n) {
      ...
      ((this.jQueryElement = e),
        ...
        (this.x = t.x),
        (this.y = t.y),
        t.x > 0.5 * n && e.find('.concept-name').addClass('concept-name_right'),
        e.on('click', function (e) {
          if (!a) return (e.preventDefault(), !1);
        }),
        e.on('mouseenter  mouseleave', i),
        (this.mapPoint = e.find('.hexagonal-map__point').css({ transform: 'scale(0)' })));
    }
    function p(e) {
      function n(e) {
        t.load(e)
      ...
      c = a.extend(c, e);
      var l =
        '<svg x="0px" y="0px" width="9" height="9"  xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><polygon vector-effect="non-scaling-stroke" style="opacity:{{alpha}};fill:{{color}};" points="{{points}}"/><polygon vector-effect="non-scaling-stroke" style="fill:none;stroke:{{color}};stroke-miterlimit:10;" points="{{points}}"/></svg>';
    ...
    a.fn.hexagonalMap = function (t) {
      var n;
      this.each(function () {
        m || (m = a.when(p({ alpha: 0.4 })));
        var i = a(this),
          o = i.data('hexagonal-map');
        (o ||
          i.data(
            'hexagonal-map',
            (o = new e.HexagonalMap(
              i,
              i.find('.hexagonal-map__canvas-map').get(0),
              i.find('.hexagonal-map__canvas-shadow').get(0),
              { size: 8, offset: 0, border: 0 }
            ))
          ),
    ...
    ((v.show = function (e) {
      s.to(this.mapPoint.get(0), 0.4, { transform: 'scale(1)', delay: e || 0, ease: Back.easeOut });
    }),
      (v.hide = function (e) {
        var t = this;
        (this.jQueryElement.off(),
          s.to(this.mapPoint.get(0), 0.4, {
            transform: 'scale(0)',
            delay: e || 0,
            ease: Sine.easeIn,
            onComplete: function () {
      ...
      (e.HexagonalMap = function (e, n, c, l) {
        function p() {
          ...
          for (var t = 1 / Q.scale, n = 0; n < U.length; n++) U[n].scale(t);
        }
        function v(e, t) {
          ((T = t), y());
        }
        ...
        function b() {
          for (var e = a.Deferred(); U.length; ) {
            var t = U.pop();
            (S.removeChild(t), t.hide());
          }
          if ((I && (I.destroy(), (I = void 0)), S.children.length > 0)) {
            $([e.promise()]);
            for (var n = 0; n < S.children.length; n++)
              !(function (t, n) {
                s.to(t, 0.25, {
                  ...
                  ease: Sine.easeOut,
                  onComplete: function () {
                    (S.removeChild(t), 0 === S.children.length && e.resolve());
                  },
                });
              })(S.children[n], n);
          } else e.resolve();
        ...
        function k(e, i) {
          function r() {
            M(m);
            for (var e = E[T].briefs, t = 0; t < e.length; t++) {
              var i = e[t],
                o = a(D(i)),
                r = o.find('.map-point'),
                s = !1;
              ...
              (r
                .toggleClass('map-point_' + i.type, !!i.type)
                .toggleClass('map-point_no-image', s)
                .toggleClass('map-point_no-works', !(i.works_count > 0)),
                o
                  .find('.hexagonal-map__concept-info')
                  .toggleClass('hexagonal-map__concept-info_no-image', s),
                A.append(o));
              var l = new d(o, u.points[h[t]], n.width);
              (S.addChild(l),
                U.push(l),
                l.addEventListener('visible:toggle', function (e) {
                  e.data.mouse && I.toggle(!e.data.visible);
                }));
            }
            (I && I.destroy(), (I = new _(U).start()), p());
          }
          var s = e,
            c = t.getImageData(i, { width: 525 }),
            u = x(c, s.info);
          i.remove();
          var h = j(u.points, u.centerPointIndex, E[T].briefs.length),
            m = f(u.points);
          ((m.width += s.info.imgWidth),
            (m.height += s.info.imgHeight),
            L.clear(),
            L.size(m.width, m.height));
          for (var g = 0; g < u.points.length; g++) {
            var v = s;
            !(function (e, t, n, i) {
              e.context.drawImage(
                n,
            ...
            })(L.random(), v.info, v.image, u.points[g]);
          }
        ...
        function _(e) {
          ...
          ((this.destroy = function () {
            ...
            (this.stop = function () {
              if (2 != i && 3 != i)
                return (r && r.initVisible(!1), (r = void 0), clearInterval(o), s);
            }));
        }
        function x(e, n) {
          for (
            var i,
              ...
              s = -n.dx,
              c = -n.dy,
              d = Math.ceil(1.5 * n.width + l.offset),
              p = Math.ceil(n.height / 2 + l.offset),
              u = [],
              f = new t.Point(0.5 * a, 0.5 * r),
              m = 999999,
              v = 0,
              w = c;
            w < r;
            ...
            for (var b = 0, y = s + (1 & v) * d * 0.5; y < a; y += d, b++)
              if (h(o, y, w, a)[3] >= g) {
                var k = new t.Point(y, w);
                k.index = { h: b, v: v };
                var _ = k.distance(f);
                ((_ < m || !i) && ((m = _), (i = u.length)), u.push(k));
              }
          return (console.debug(v, b), { points: u, centerPointIndex: i });
        }
        function j(e, t, n) {
          function o(e, t) {
            for (var n = [], i = t.length - 1; i >= 0; i--) C(e, t[i]) && n.push(t.splice(i, 1)[0]);
            return n;
          }
          for (
            var a = [].concat(e),
        ...
        function C(e, t) {
          ...
          return (
            ...
            (n < 4 &&
              n % 2 == 1 &&
              (0 == i || e.index.h + ((e.index.v % 2) * 2 - 1) == t.index.h)) ||
            (0 == n && i < 2)
          );
        }
        function M(e) {
          ...
          for (var i = [], o = 0; o < L.canvases.length; o++) {
            ((t = new r.Bitmap(L.canvases[o])), (t.alpha = 0), S.addChild(t));
            var l = a.Deferred();
            (s.to(t, 0.5, {
              alpha: 1,
              delay: 0.2 + 0.1 * o,
          ...
          $(i).then(function () {
            for (var e = Math.max(0.08, Math.min(0.2, 1 / U.length)), t = 0; t < U.length; t++)
              U[t].show(0.2 + t * e);
          });
        }
        function $(e) {
          ...
          function i() {
            (S.update(),
              H.cache(0, 0, n.width, n.height),
              P.update(),
              o && (r.Ticker.removeEventListener('tick', i), s.resolve()));
          }
          var o,
            s = a.Deferred();
          return (
            r.Ticker.addEventListener('tick', i),
        ...
        var E,
          ...
          I,
          z = void 0,
          O = e.closest('.kaspersky-app').find('.city-name'),
          ...
          U = [],
          A = e.find('.hexagonal-map__points-cont'),
          Q = {};
        (a(o.documentElement).on('resize:after', function () {
          ((Q.scale = parseFloat(a(this).css('fontSize')) / 18), p());
        }),
      ...
      (u.prototype.size = function (e, t) {
        ...
        for (var n = 0; n < this.canvases.length; n++)
          ((this.canvases[n].width = e), (this.canvases[n].height = t));
        return this;
      }),
...
!(function (e, t, n) {
  function i(i) {
    ...
    function r() {}
    var s,
      c = i.find('form').on('form:submit', o);
...
!(function (e, t, n) {
  function i(e) {
    ...
    function a() {}
    var r,
      s = e.find('form').on('form:submit', i);
...
!(function (e, t, n, i) {
  function o(o) {
    ...
    var s,
      ...
      p = o.find('.modal-message__body');
    (e(t).on('hashchange', r),
      o.find('.button_no-lines').on('click', a),
      (i.alert = function (t, i, o) {
        ('already voted: agree' == t
          ? (t = e.fn.localization.getText('voted.agree') || 'already voted: agree')
          : 'already voted: disagree' == t &&
            (t = e.fn.localization.getText('voted.disagree') || 'already voted: disagree'),
          l.init(t, i),
          n.modal('alert', o || location.hash));
      }),
      (this.init = function (e, t) {
        (d.html((s = e || '')), p.html((c = t || '')), r());
      }));
  }
...
(!(function (e, t) {
  ...
  e.fn.authorization = function (a) {
    return (
      (o = a || o),
      !i && this.length > 0 && ((i = !0), e(t).on('login:change', n), n()),
      this
    );
  };
})(jQuery, window),
  (function (e, t, n) {
    ...
    function o(o) {
      ...
      function s(i, a) {
              ...
              .get(function (e, t) {
                e ||
                  (d
                    ...
                    .userPicCrop(t, o.data('title'))
                    .on('user-pic-crop:save', s),
                  u.val(''));
              }));
        }
        function s(e, n) {
          var r = (n.height * c.height) / (n.width * c.width),
            ...
            u = Math.max(0, Math.min(n.height, 1 - n.y, n.height + n.y)),
            h = p / n.width,
            f = u / n.height;
          t.Image(i)
            .rotate(l[a])
            .crop(s * c.width, d * c.height, p * c.width, u * c.height)
            .get(function (e, t) {
              if (e) console.warn('upload error', e);
                ...
                console.log([
                  ...
                  t.height,
                  t.height / r,
                  Math.max(t.width, t.height / r),
                  Math.min(1e3, Math.max(t.width, t.height / r)),
                ]);
                (i
                  .getContext('2d')
                  .drawImage(
        ...
        var c,
          d = e('.js-user-pic-block');
        (d.is(':visible') || peppers.modal('user-pic-crop', n.hash), t.getInfo(i, r));
      }
      var c = 1,
        l = { 8: 270, 3: 180, 6: 90, 7: 270, 4: 180, 5: 90 },
        d = peppers.checkMobile.css.isMobile() ? 484 : 333,
        p = { preview: { width: d, height: d } },
        u = e(
          '<input class="upload-image__input" name="photo" type="file" accept=".jpg,.jpeg,.png" />'
        );
      (o.append(u),
        t.event && t.event.on(u.get(0), 'change', a),
        (function () {
  ...
  (function (e, t, n) {
      ...
      ((n = n || ''),
        t.each(function () {
          ...
          switch (!0) {
            ...
            default:
              (t
                .closest('.user-panel__stat-item')
                .toggleClass('user-panel__stat-item_empty', !n && 0 !== n),
    ...
    ((e.fn.userData = t.jQueryConstructor('UserData', i)),
      ...
      (i.prototype.update = function (e) {
        if (
          (void 0 === e || (e.user.suadmin, 0) ? (window.suadmin = !1) : (window.suadmin = !0),
          this.api || e)
        ) {
          e = e || this.api();
...
(!(function (e, t, n) {
  function i(t) {
    ((t = encodeURIComponent(t).replace(/\%2F/g, '%5C')), (e.location = o + '?q=' + t));
  }
  var o = e.langUrl + 'search/';
  ...
  (function () {
    function e(e) {
      ...
      (n ||
        ((n = t.scrollbarCustom().data('scrollCustom')),
    ...
    function n(e, t) {
      ...
      function i() {
        $(u).filter('.my-discussion_hide').length
          ? m.addClass('paginator--show')
          : m.removeClass('paginator--show');
      }
      function o() {
        (peppers.checkMobile.css.isMobile() ||
          ((d = e.offset().top),
          (l = m.offset().top),
          u && u.length > 0 && u.data('bottom', void 0)),
          a(h));
      }
      function a(t, n) {
        (m.removeClass('paginator_no-next paginator_no-prev'),
          u && u.removeClass('my-discussion_hide'),
          g.toggle(!(u && u.length > 0)),
          u &&
            u.length > 0 &&
            (t >= u.length && ((t = u.length), (n = !0)),
      ...
      function s(e, t) {
        ...
        if (t)
          for (; a-- > 0; )
            ((n = u.eq(a)), (i += n.outerHeight()) < l - d && ((h = a), (o = o.add(n))));
        for (a = e; a < u.length; a++)
          ((n = u.eq(a)), (i += n.outerHeight()) < l - d && ((f = a), (o = o.add(n))));
        (console.debug(o),
          o.removeClass('my-discussion_hide'),
          u.not(o).addClass('my-discussion_hide'),
          m.toggleClass('paginator_no-next', f >= u.length - 1),
          m.toggleClass('paginator_no-prev', h <= 0));
      }
      function c() {
      ...
      var l,
        ...
        h,
        f,
        m = e.siblings('.paginator'),
        g = e.find('.user-panel__placeholder');
      p = t;
      var v = 1;
  ...
  (function (e, t) {
    function n(t) {
      ...
      function i() {
        ((l = c.serialize()), p.addClass('button_inactive'));
      }
      function o(t) {
        (t.preventDefault(),
          e(this).is('.button_inactive') ||
            r(c.serializeArray())
              .done(function () {
                peppers.modal();
              })
  ...
  (function (e, t, n) {
    function i(n) {
      function i() {}
      function o(t, n) {
        e('#avatar-input').length
          ? (e('#avatar-input').val(n.toDataURL('image/jpeg')),
      ...
      function l(t) {
        ...
        (i > g && (i = g),
          i < v && (i = v),
          e(this).find('.js-viewer').css({ width: i, height: i }));
      }
      function d(n) {
        ((m = 'scale'),
          n.preventDefault(),
          b.on('mousemove touchmove', a),
          e(t).on('mouseup  touchend', p));
      }
      function p(n) {
        (b.off('mousemove touchmove', a).off('mousemove touchmove', r),
          e(t).off('mouseup  touchend', p),
          'move' === m && (k = _));
      }
      function u(n) {
      ...
      (e('.user-pic-crop__dot', b).on('touchstart  mousedown', d),
        e('.js-pic-save', n).on('click', h),
        e('.user-pic-block__image-wrap').on('wheel', l),
        b.on('touchstart  mousedown', u));
      var k,
        _,
        x = n.find('.select-file').uploadImage().on('upload-image:crop', o),
        j = n.find('.js-viewer');
      (n.on('modal-item:hide', f), e(t).on('hashchange', i));
      var C;
      this.init = function (t, i) {
        if ((x.data('title', i), !t)) return (C && C.off().remove(), (C = void 0), !1);
        (n.toggleClass('user-pic-crop_edit', !!((t && !0 !== t) || C)),
          !0 !== t &&
            (C && C.off().remove(),
            (C = t && e(t).appendTo(y).addClass('user-pic-crop__target')),
            (k = { left: -2e3, right: -2e3, top: -2e3, bottom: -2e3 }),
            r(),
            b.css('fontSize', '')));
      };
    }
      ...
      switch (e) {
        ...
        default:
          (this.$comments && this.$comments.remove(),
            e &&
              ((this.$comments = t(this.template(e)).insertAfter(this.script)),
  ...
  (n.registerHelper('ifAuthor', function (e, t, n) {
    ...
    (i.prototype.init = function (e) {
      e &&
        ...
        this.ui
          .find('.user-pic')
          .addClass('user-pic--visible')
          .find('.user-data__userpic')
          .css('background-image', "url('" + (e.author && e.author.image) + "')"));
    }));
})((peppers = peppers || {}), jQuery, Handlebars);
var peppers;
!(function (e, t, n) {
  ...
  function a() {
    var e = c.is(':checked');
    ($('.js-mobile-menu-overlay').toggleClass('open', e),
      $('body').toggleClass('fixed', e),
      s.trigger('menu:' + (e ? 'show' : 'hide')).trigger('menu:toggle'),
      $('.js-mobile-menu').toggleClass('open', e));
  }
  function r(e) {
    e
  ...
  ($(n).on('click', '.js-mobile-menu-overlay', function () {
    ...
    $('.nav-menu__link_lang').on('click', function (e) {
      (e.preventDefault(),
        e.stopPropagation(),
        $(this).data('lang') &&
          (o('/backend/api/v1/set/' + $(this).data('lang')),
    ...
    $(n).on('click', '.js-tooltip-menu', function () {
      ...
      ($(t).width() >= 1e3 || e.hasClass('mobile-event')) &&
        (e.hasClass('open')
          ? (r(!1), e.removeClass('open').fadeOut(200))
          : (r(!0),
            $('.js-tooltip-window').removeClass('open').fadeOut(200),
            e.addClass('open').fadeIn(200)));
    }),
    $(n).on('click', function (e) {
      0 == $(e.target).closest('.js-tooltip-window').length &&
        0 == $(e.target).closest('.js-tooltip-menu').length &&
        $(n).trigger('menu.closeMenu');
    }),
...
(!(function (e, t) {
  $(t).on('click', '.js-search-btn', function (e) {
    (e.preventDefault(),
      ...
      $('.js-search-form').hasClass('active') &&
        ($('.js-search-form input[type=text]').get(0).focus(),
        $('#k-menu-toggle').prop('checked') &&
          ($('#k-menu-toggle').prop('checked', !1), $('#k-menu-toggle').change())));
  });
})(window, document),
  (function (e, t) {
    function n(e) {
    ...
    function i(n, i) {
      ...
      void 0 !== r &&
        (r.hasOwnProperty('attr') && a.attr(r.attr),
        ['string', 'number'].indexOf(typeof r) >= 0
          ? a.html(r)
          : r.hasOwnProperty('length')
            ...
            : (r.hasOwnProperty('desktop') || r.hasOwnProperty('mobile')) &&
              (function () {
                a.html(
                  "<span class='mobile-only'>" +
                    r.mobile +
                    "</span><span class='desktop-only'>" +
                    r.desktop +
                    '</span>'
                );
              })());
    ...
    ((e.fn.localization = function (t, o) {
      ...
      function p(e) {
        ((r = e),
          h.find('[data-localization]').each(function () {
            l.push(new i(this, e));
          }),
          u.resolve());
      }
      if ('destroy' !== t) {
        ...
        return (
          o && (a = o),
          a || s[t]
            ? ((s[t] = s[t] || a(t, n)), c[t] && c[t].resolve(s[t]), s[t].done(p))
            : (c[t] || (c[t] = e.Deferred()), c[t].then(d)),
          u.promise()
        );
      }
    }),
  ...
  (function (e, t, n, i) {
    e.fn.welcome = function () {
      ...
      function a(e, n) {
        ...
        var h;
        if (((u = d), e >= p.length)) return void c.fadeOut(o);
        var f = p.eq(e).show(),
          m = f.find('.welcome__l');
        ((n = n || 0), m.css('opacity', 0).each(r(1, 0.5, n, 0.025, i)));
      }
  ...
  (function (e, t, n, i, o, a, r) {
    function s() {
      (console.log('main ready'),
        ...
        (t.sortPrediction = c('predictions', void 0, !1, 'post')),
        (t.sortFuturolog = c('futurolog', void 0, !1, 'post')),
        (t.sortArtwork = c('graphics', void 0, !1, 'post')),
        (t.sortArtist = c('artists', void 0, !1, 'post')),
        (t.searchUrl = langUrl + 'search/'),
        (t.preload =
        ...
        o('.js-select').select2({ minimumResultsForSearch: 1 / 0 }),
        (t.sortRedrawList = function (e, n, i, a, r) {
          var s = o(i);
          (s.addClass('fade-block'),
            a({ sort: e, type: n }).fail(function (i) {
              (s.html(i),
                s.data('action', t.getUrlMethod(e, { sort: e, type: n })),
                s.data('page', '1').addClass('js-ajax-loading'),
                r && r(),
                setTimeout(function () {
        ...
        'undefined' != typeof InstallTrigger &&
          o('.close-button-hexagon, .back-btn-svg').hexButton(),
        o(function () {
          function e(e) {
            ((e = e || ~~o.cookie(n) || i[(i.length - 1) >> 1]),
              o('.timeline-new')
                .pepTimeline(i, e)
                .on('timeline:change', function (e, t) {
    ...
    function c(e, t, i, a, r) {
      ...
      var u,
        ...
        m = 'work-save' == e;
      return (
        (u = langUrl + 'api/' + (w.hasOwnProperty(e) ? w[e] : '')),
        function (n, r, l) {
          function p(e, t) {
            for (var n in e)
          ...
          return (
            (c(e) ? s : f)(g, b, l || a || (b ? 'post' : 'get'), m)
              ...
              .fail(function (e) {
                e.responseJSON
                  ? h(e.responseJSON)
                  : k.reject(e.message || e.responseText || 'ERROR');
              }),
            !0 === i &&
              ((v[u] = _),
              _.fail(function () {
    ...
    function l() {
      function t() {
        (o.cookie('visited-2', '1', { expires: 3650, path: '/' }),
          o(this).off('mousedown  touchstart', t),
          o('.help').fadeOut());
      }
      if (e.checkMobile.css.isMobile())
        return void o.cookie('visited-2', '1', { expires: 3650, path: '/' });
    ...
    (!(function () {
      (!(function () {
        ...
        (function () {
          r.registerHelper('howMuch', function (e) {
            var t;
            ((t =
              2 == e.toString().length && 1 == e.toString().substr(-2, 1)
                ? 5
                : e.toString().substr(-1)),
              (t = t.toString()));
            var n;
      ...
      (function () {
        function e(e, t) {
          ...
          t
            ? (void 0 === n && (n = m.scrollTop()),
              e.css({ top: -n, position: 'fixed', width: '100%' }))
            : (e.css({ top: '', position: '', width: '' }),
      ...
      (function () {
        ...
        function n() {
          ...
          (m.css('fontSize', 18 * Math.min(1, n / c.w)),
            m.toggleClass(
              'landscape',
              r && e.checkMobile.isMobileOrTablet() && screen.width < 1280
            ));
      ...
      h.ready(s),
      o(i).on('panetMainLoaded', function () {
...
var CSelectList = function (e) {
  ((this.element = $(e)),
    ...
    (this.wrapDesktopSelect =
      '<div><div class="select-menu__hide-menu popup-select tooltip-menu js-tooltip-window"></div></div>'),
    (this.wrapDesktopActiveItem =
      '<div><div class="js-tooltip-menu select__select-button"></div></div>'),
    (this.svglist =
      '<svg class="select__sort-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="#FFF" fill-rule="evenodd" d="M3 3h10a1 1 0 0 1 0 2H3a1 1 0 1 1 0-2zm0 4h7a1 1 0 0 1 0 2H3a1 1 0 1 1 0-2zm0 4h4a1 1 0 0 1 0 2H3a1 1 0 0 1 0-2z" opacity=".3"/></svg>'),
    (this.svgmenu =
      '<svg class="select-menu__icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 8.303L5.349 5.65A1.2 1.2 0 1 0 3.65 7.35l3.5 3.5a1.2 1.2 0 0 0 1.698 0l3.5-3.5A1.2 1.2 0 0 0 10.65 5.65L8 8.303z"></path></svg>'),
    this.initElement(),
    this.setEvents());
};
((CSelectList.prototype.initElement = function () {
  ...
  (this.select.find('option').each(function (t) {
    e.find('.tooltip-menu').append(
      "<span data-num='" + $(this).val() + "'>" + $(this).html() + '</span>'
    );
  }),
    this.element.append(e.html()),
    this.element.append(this.svglist));
  var t = $(this.wrapDesktopActiveItem);
  (t.find('.js-tooltip-menu').append('<span class="select__select-item js-active-item"></span>'),
    t.find('.js-tooltip-menu').append(this.svgmenu),
    this.element.append(t.html()),
  ...
  (CSelectList.prototype.changeDesctopSelect = function (e) {
    ...
    (this.element.find('.tooltip-menu span').removeClass('active'),
      t.addClass('active'),
      this.element.find('.js-active-item').text(t.text()),
      $(document).trigger('menu.closeMenu'),
      this.updateSelectItem(),
      this.element.trigger('ajaxSortUpdate', [t.data('num')]));
  }),
  (CSelectList.prototype.updateDesctopItem = function () {
    var e = this.select.find('option:selected');
    (this.element.find('.js-active-item').text(e.text()),
      this.element.find('.tooltip-menu span').removeClass('active'),
      this.element.find('.tooltip-menu span[data-num=' + e.val() + ']').addClass('active'));
  }),
  (CSelectList.prototype.updateSelectItem = function () {
    var e = this.element.find('.tooltip-menu span.active').data('num');
    this.select.val(e);
  }),
  $('.js-select-list').length > 0 &&
    $('.js-select-list').each(function (e) {
  ...
  (function () {
    ...
    ($(document).on('click', '.js-toogle-main-page', function () {
      ...
      $(document).on('click', '.js-toggle-demo', function () {
        if (
          $('.js-toggle-map').eq(0).is('.is-active') ||
          $('.js-toggle-demo').eq(0).is('.is-active')
        )
          if (
            ($('.js-toggle-map').removeClass('is-active toogle-page__link--active'),
            ...
            var e = setInterval(function () {
              2050 === window.YEAR_ID
                ? (clearInterval(e), setTimeout(t, 2e3))
                : $('.js-timeline-item[data-year="2050"]').eq(0).trigger('click');
            }, 1e3);
          }
        else
          $('.js-toggle-feed').eq(0).is('.is-active') &&
            (sessionStorage.setItem('demoIsOn', 'true'),
            $('.js-toogle-main-page.js-toggle-map').eq(0).trigger('click'));
      }),
      'true' === sessionStorage.getItem('demoIsOn') &&
